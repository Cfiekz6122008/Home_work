...
# Создаем танки (квадраты) с различными цветами
player = Tank(canvas, x=100, y=100, color='red')   # Красный танк
enemy = Tank(canvas, x=120, y=110, color='blue')    # Синий танк
green_tank = Tank(canvas, x=185, y=120, color='green')  # Зеленый танк
